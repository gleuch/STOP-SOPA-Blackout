      ...
      if (localStorage.disable_sopa_blackout == '1') {
        html = ' \
          <div id="sopa_blackout_promote" class="skip_stop_sopa" style="position: fixed; z-index: 3000; top: 0; right: 0;"> \
           <a onmouseover="this.style.opacity=.64;" onmouseout="this.style.opacity=1.0;" style="display: inline-block !important; margin: 5px !important; padding: 8px 8px 7px 8px !important; font: 18px/18px normal Helvetica,Arial,sans-serif !important; color: #fff !important; background: #f0f !important; text-shadow: 0 1px 2px rgba(0,0,0,.18) !important; box-shadow: 0 1px 2px rgba(0,0,0,.18) !important; font-weight: bold !important; border: 1px solid #f0f !important; border-radius: 7px !important; text-decoration: none !important; font-style: normal !important;" href="http://americancensorship.org" title="http://americancensorship.org/" target="_blank" id="sopa_blackout_action">STOP CENSORSHIP!</a> \
          </div> \
        ';
